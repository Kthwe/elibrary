...
if(isset($_POST['signup']))
{
	...
	if ($roll_no > 150) {
		array_push($errors, "Exceed limited number");
		echo  "<script>alert('Exceed limited number');</script>";
	  }
	$student_id .="-" .$roll_no;
	...
	$msg=mysqli_query($con,"insert into users(fname,lname,email,password,contactno,student_id,user_activation_code,user_email_status) values('$fname','$lname','$email','$enc_password','$contact','$student_id', '$user_activation_code','not verified')");
if($msg)
{
			$email = $_POST['email'];
			$subject = "e-mail Verification";
			$base_url = "http://192.168.43.181/dashboard/assets/loginsystem2/";  //change this baseurl value as per your file path
			$message = "
			<Hi ".$_POST['fname'].",
			...
			echo  "<script>alert('Verification URL has been sent. Check your inbox');</script>";
}}}
					...
					<div class="facts">
						...
						<div class="register">
							<form name="registration" method="post" action="" enctype="multipart/form-data">
								...
								<input type="roll_no" value="" name="roll_no"  required><br><br>
