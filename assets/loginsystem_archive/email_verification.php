	...
	if($no_of_row > 0)
	{
		...
		foreach($result as $row)
		{
			if($row['user_email_status'] == 'not verified')
			{
				...
				if(isset($sub_result))
				{
					$message = '<label class="text-success">Your Email Address Successfully Verified <br />You can login here - <a href="http://192.168.43.181/dashboard/assets/loginsystem2/welcome2us.php">Login</a></label>';
				}
			}
			else
			{
